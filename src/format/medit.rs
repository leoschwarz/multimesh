...
/*
pub struct MeditSerializer<'m, Mesh: 'm> {
    mesh: &'m Mesh,
}

impl<'m, Mesh> MeditSerializer<'m, Mesh>
where
    Mesh: SerializeMesh,
{
    pub fn write<W: Write>(&self, mut writer: W) -> Result<(), SerializeError> {
        // TODO: include version information of crate
        writeln!(writer, "MeshVersionFormatted 1")?;
        writeln!(writer, "# MEDIT mesh file, generated by multimesh")?;

        // Get dimensionality.
        let mesh_dim = self.mesh.ser_dimension();
        // TODO: maybe check if it is a legal dimension (check format docs)?
